<template>
  <div
    class="bg-gray-200 dark:bg-gray-800 min-h-screen p-3 flex items-center justify-center flex-col"
  >
    ...
    <button
      ...
      "
    >
      <IconC iconName="HomeIcon" iconClass="w-5 h-5 mr-2" />Go back home
    </button>
  </div>
</template>

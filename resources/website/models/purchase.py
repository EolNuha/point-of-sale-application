...
class Purchase(db.Model):
    ...
    purchase_type = db.Column(
        db.Enum("purchase", "investment", "expense"), default="purchase"
    )
...
class PurchaseItem(db.Model):
    ...
    product_purchased_price_wo_tax = db.Column(
        db.Numeric(precision=10, scale=4), default=0
    )
    ...
    product_expiration_date = db.Column(db.DateTime, default=None)

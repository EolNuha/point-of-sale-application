        ...
        >
          <li>
            <button
              ...
              class="inline-flex justify-center items-center p-50 text-sm text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
